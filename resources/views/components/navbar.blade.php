<nav class="bg-gray-800" x-data="{ isOpen: false }">
            ...
            <div class="relative ml-3">
              <div>
                <button type="button" @click="isOpen = !isOpen" class="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 focus:outline-hidden" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                  ...
                  <img class="size-8 rounded-full" src="https://assets.laliga.com/squad/2024/t178/p593109/2048x2048/p593109_t178_2024_1_003_000.png" alt="">
                </button>
              </div>
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
      <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
        <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
        <a href="/" class="block rounded-md bg-gray-900 px-3 py-2 text-base font-medium text-white" aria-current="page">Terbaru</a>
        <a href="olahraga" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Olahraga</a>
        <a href="#" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Teknologi</a>
        <a href="#" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Hiburan</a>
        ...
        <a href="#" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Politik</a>
      </div>
      <div class="border-t border-gray-700 pt-4 pb-3">
        <div class="flex items-center px-5">
          <div class="shrink-0">
            <img class="size-10 rounded-full" src="https://assets.laliga.com/squad/2024/t178/p593109/2048x2048/p593109_t178_2024_1_003_000.png" alt="">
          </div>
          <div class="ml-3">
            <div class="text-base/5 font-medium text-white">Yuuza</div>
            <div class="text-sm font-medium text-gray-400">yuuza@example.com</div>
          </div>
        </div>
        <div class="mt-3 space-y-1 px-2">
          ...
          <a href="#" class="block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white">Keluar</a>
        </div>
      </div>
    </div>
  </nav>